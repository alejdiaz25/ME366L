...
p3 = m.addVar(lb=0, name="p3")
p4 = m.addVar(lb=0, name="p4")
p5 = m.addVar(lb=0, name="p5")
p6 = m.addVar(lb=0, name="p6")

# regular full-time (covers i, i+1)
f1 = m.addVar(lb=0, name="f1")
f2 = m.addVar(lb=0, name="f2")
f3 = m.addVar(lb=0, name="f3")
f4 = m.addVar(lb=0, name="f4")
f5 = m.addVar(lb=0, name="f5")
f6 = m.addVar(lb=0, name="f6")

# regular split-shift (covers i, i+2)
s1 = m.addVar(lb=0, name="s1")
s2 = m.addVar(lb=0, name="s2")
s3 = m.addVar(lb=0, name="s3")
s4 = m.addVar(lb=0, name="s4")
s5 = m.addVar(lb=0, name="s5")
s6 = m.addVar(lb=0, name="s6")

# premium full-time (covers i, i+1), costs 1.1*cF
g1 = m.addVar(lb=0, name="g1")
g2 = m.addVar(lb=0, name="g2")
g3 = m.addVar(lb=0, name="g3")
g4 = m.addVar(lb=0, name="g4")
g5 = m.addVar(lb=0, name="g5")
g6 = m.addVar(lb=0, name="g6")

# premium split-shift (covers i, i+2), costs 1.1*cS
h1 = m.addVar(lb=0, name="h1")
h2 = m.addVar(lb=0, name="h2")
h3 = m.addVar(lb=0, name="h3")
h4 = m.addVar(lb=0, name="h4")
h5 = m.addVar(lb=0, name="h5")
h6 = m.addVar(lb=0, name="h6")
